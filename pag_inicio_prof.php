                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            ...
                            <table class="table table-border table-striped">
                                ...
                                <tbody>
                            <?php 
                            $result = $conn->prepare("SELECT * FROM grupos WHERE id_prof_fk = '$id_prof'");
                             $result->execute();
                            for($i=0; $row = $result->fetch(); $i++){
                                echo "<tr>";
                                echo "<td>";
                                ...
                                echo "</td>";
                                echo "<td>";
                                $result2 = $conn->prepare("SELECT count(id_participante) FROM participante WHERE id_grupo_fk = ".$row['id_grupo'].";");
                                $result2->execute();
                               for($i=0; $ro = $result2->fetch(); $i++){ 
                                  echo $ro[0];
                                }
                                echo "</td>";
                                echo "<td>";
                                echo "<a class='btn btn-success' href='ver_alunos.php?id_grupo=";
                                echo $row['id_grupo'];
                                echo "'>Ver Alunos</td>";
                                echo "</tr>";
                            }
