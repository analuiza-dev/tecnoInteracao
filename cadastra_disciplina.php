                ...
                <div class="jumbotron">
                    ...
                    <form class="form-horizontal" action="" method="POST">
                        <div class="input-container">
                          <i class="icon">Nova disciplina:</i>
                          <input class="form-control" class="input-field" type="text" placeholder="Nova disciplina" name="nome_disc" required>
                      </div>
...
if (isset($_POST['nome_disc'])) {
    ...
    $result = $conn->prepare("INSERT INTO disciplina (nome_disciplina) VALUES ('$nome_disc')");
    if($result->execute()){
        echo "<script type='text/javascript'>alert('Disciplina cadastrada com sucesso!')</script>";
    }else{
        echo "<script type='text/javascript'>alert('Erro ao cadastrar disciplina!')</script>";
    }
