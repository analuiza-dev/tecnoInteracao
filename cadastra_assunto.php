                ...
                <div class="jumbotron">
                    ...
                    <form class="form-horizontal" action="" method="POST">
                      <div class="input-container">
                          <i class="icon">Novo assusto:</i>
                          <input class="form-control" class="input-field" type="text" placeholder="Novo assusto" name="nome_assunto" required>
                      </div>
                      <br>
                      <div class="input-container">
...
<?php
if (isset($_POST['nome_assunto'])) {
    $nome_assunto = $_POST['nome_assunto'];
    $disc = $_POST['id_disc'];
    if ($disc == "") {
        echo "<script type='text/javascript'>alert('Selecione a disciplina!')</script>";
    }else{
        $result = $conn->prepare("INSERT INTO assunto (nome_assunto,id_disciplina_fk) VALUES ('$nome_assunto','$disc')");
        if($result->execute()){
            echo "<script type='text/javascript'>alert('Assunto cadastrado com sucesso!')</script>";
        }else{
            echo "<script type='text/javascript'>alert('Erro ao cadastrar assunto!')</script>";
        }
