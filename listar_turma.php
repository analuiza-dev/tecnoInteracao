          ...
          <div class="row">
            ...
            <div class="col-md-12"> 
              <table class="table table-bordred table-striped" id="a">
               ...
               <?php 
               $result = $conn->prepare("SELECT * FROM turma ORDER BY serie_turma, curso");
               $result->execute();
               for($i=0; $row = $result->fetch(); $i++){
                 ...
                 <tr>
                   ...
                   <td style="text-align:center; word-break:break-all; width:200px;"> <?php echo $row ['serie_turma']; ?></td>
                   <td style="text-align:center; word-break:break-all; width:200px;"> <?php echo $row ['curso']; ?></td>
                   <td style="text-align:center; word-break:break-all; width:200px;"> <?php echo $row ['ano_turma']; ?></td>
                   <td style="text-align:center; width:350px;">
                    <a href="acoes/editar_turma.php<?php echo '?id='.$id; ?>" class="btn btn-info">Editar</a>
                     ...
                     <div class="modal-dialog">
                      ...
                      <div class="modal-content">
                        <div class="modal-header">
                          ...
                          <a href="listar_turma.php"class="close">&times;</a>
                        </div>
                        <div class="modal-body">
                         ...
                         <div class="modal-footer">
                          <a href="listar_turma.php" class="btn btn-success">Não</a>
