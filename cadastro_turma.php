                    ...
                    <form class="form-horizontal" action="" method="POST">
                        <div class="form-group">
                            <div class="input-container">
                              <i class="icon">Ano:</i>
                              <input class="form-control" class="input-field" type="text" placeholder="Ano Turma" name="ano" required>
                          </div>
                          <div class="input-container">
                            <i class="icon">Serie:</i>
                            <input class="form-control" class="input-field" type="text" placeholder="Serie Turma" name="serie" required>
                        </div>
                        <div class="input-container">
                          <i class="icon">Turma:</i>
                          <input class="form-control" class="input-field" type="text" placeholder="Curso Turma" name="turma" required>
                      </div>
                      <br>
...
if (isset($_POST['ano'])) {
    ...
    $serie = $_POST['serie'];
    $turma = $_POST['turma'];
    $sql = "INSERT INTO turma (ano_turma, serie_turma, curso) VALUES ('$ano','$serie','$turma');";
    $conn->exec($sql);
    echo "<script type='text/javascript'>alert('Turma cadastrada com sucesso!')</script>";
}
}else if($aut == "prof"){
    echo "<center>";
